...
--
-- Name: steam_stats uk_e9usu28ymyxywu9ncikt0ofib; Type: CONSTRAINT; Schema: public; Owner: integration
--

ALTER TABLE ONLY public.steam_stats
    ADD CONSTRAINT uk_e9usu28ymyxywu9ncikt0ofib UNIQUE (game_record_id);


--
-- Name: twitch_stats uk_qgm26uo1xyp3po9o86b0pdvwq; Type: CONSTRAINT; Schema: public; Owner: integration
--

ALTER TABLE ONLY public.twitch_stats
    ADD CONSTRAINT uk_qgm26uo1xyp3po9o86b0pdvwq UNIQUE (game_record_id);
